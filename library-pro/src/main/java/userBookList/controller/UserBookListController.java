...
public class UserBookListController {
	...
	public ModelAndView ShowMyUser(ModelAndView mav, HttpSession session, String user_id) {
		...
		// 현재 대출/예약중인 도서 조회
		List<UserBookListDTO> CurrBookList = userBookListService
		...
		// 대출 내역 조회
		List<UserBookListDTO> PastBookList = userBookListService
				.PastBorrowListProcesss((String) session.getAttribute("keynum"));
